...
| Platform | Archive |
| --- | --- |
| macOS (Apple Silicon) | `zioscp-v0.7.3-aarch64-macos.tar.gz` |
| macOS (Intel) | `zioscp-v0.7.3-x86_64-macos.tar.gz` |
| Linux (x86_64) | `zioscp-v0.7.3-x86_64-linux-gnu.tar.gz` |
| Linux (arm64) | `zioscp-v0.7.3-aarch64-linux-gnu.tar.gz` |
| Windows (x86_64) | `zioscp-v0.7.3-x86_64-windows-gnu.zip` |
